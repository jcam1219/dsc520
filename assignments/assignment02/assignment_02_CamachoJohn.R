...
person_df1 <- read.csv("C:/Users/Joslyn/Desktop/John Documents/Data Science Class/DSC520/dsc520/data/tidynomicon/person.csv")
str(person_df1)
...
person_df2 <- read.csv("C:/Users/Joslyn/Desktop/John Documents/Data Science Class/DSC520/dsc520/data/tidynomicon/person.csv", stringsAsFactors = FALSE)
str(person_df2)

## Read the file `data/scores.csv` to `scores_df`
## Display summary statistics using the `summary()` function
scores_df <- read.csv("C:/Users/Joslyn/Desktop/John Documents/Data Science Class/DSC520/dsc520/data/scores.csv")
summary(scores_df)
...
excel_sheets("C:/Users/Joslyn/Desktop/John Documents/Data Science Class/DSC520/dsc520/data/G04ResultsDetail2004-11-02.xls")
...
voter_turnout_df1 <- read_excel("C:/Users/Joslyn/Desktop/John Documents/Data Science Class/DSC520/dsc520/data/G04ResultsDetail2004-11-02.xls", skip = 1)
...
voter_turnout_df2 <- read_excel("C:/Users/Joslyn/Desktop/John Documents/Data Science Class/DSC520/dsc520/data/G04ResultsDetail2004-11-02.xls", sheet = "Voter Turnout", col_names = c("ward_precint", "ballots_cast", "registered_voters", "voter_turnout"), skip = 2)
...
db <- dbConnect(RSQLite::SQLite(), "C:/Users/Joslyn/Desktop/John Documents/Data Science Class/DSC520/dsc520/data/tidynomicon/example.db")
